...
class Philosopher:
    ...
    def get_forks(self, id, NUMBER_PHILOSOPHERS):
    ...
    def eat(self):
        ...
        time.sleep(random.uniform(1, 2))  # Isst für 1-2 Sekunden
    ...
    def try_to_eat(self):
        ...
        if self.right_handed:
            self.start_with_right()
        else:
            self.start_with_left()
